...
function DiseaseReportD({selectedDataD}) {
  ...
  return (
    ...
    <Dialog open={open} onClose={handleClose}>
      <DialogTitle><Typography>D Due to</Typography></DialogTitle>
      <DialogContent>
        <DialogContentText>
        <Container>
  ...
  {selectedDataD && (
      <div style={{display: 'flex', flexDirection: 'row', marginTop: '10px'}}>
        <span style={{width: '60%', alignItems: 'flex-start'}}>{selectedDataD.title}</span>
